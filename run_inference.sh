...
#     --evaluate_dir /dccstor/niccoloav/mm-cot/experiment_qcmue_80_perc/rationale_declare-lab-flan-alpaca-base_vit_QCMU-UE_lr8e-05_bs8_op512_ep20 \
#     --test_le /dccstor/niccoloav/mm-cot/models/mm-cot-base-ans/predictions_ans_test.json \
#     --load_ua \
#     --method "preds" \
    # --final_eval \
