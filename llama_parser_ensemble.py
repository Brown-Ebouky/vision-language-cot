...
def main(args):
    ...
    filenames = [
        # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_4.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_5.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_7.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_8.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_9.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_0.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_1.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_2.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_3.json",
        # # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_reflect_6.json",
        # "/dccstor/niccoloav/mm-cot/various_results/llama_qcmg_a.json",
        # "/dccstor/niccoloav/mm-cot/various_results/llama_qcmg_a_llava_caption.json",
        # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_greedy.json",
        # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm.json",
        # "/dccstor/niccoloav/mm-cot/llama_qcmg_a_llava_caption_qcm_2_steps_pt_1.json"
        "/dccstor/niccoloav/mm-cot/llama_qcmg_a_70b_seed_5.json",
        "/dccstor/niccoloav/mm-cot/llama_qcmg_a_70b.json"
    ...
    for file in filenames:
        ...
        for i, s in enumerate(data["preds"]):
            ...
            try:
                ...
                ans_dict[i] = []
            ans_dict[i] += [a for a in ans] 
    print(count_parse_problems)
    with open('/dccstor/niccoloav/mm-cot/parsed_reflect.json', 'w') as f:
        json.dump(ans_dict, f, indent=4)
    # print(f"The Number of weird parsing is: {count_parse_problems}")
    conunt_weird_mode = 0
    for tries in ans_dict.values():
        from statistics import mode
           # Returns all unique items and their counts
        # tries = [t for t in tries if t != "T"]
        # tries = [t for t in tries if t != "N"]
        if len(tries) != 5 or len(set(tries)) != 1:
            conunt_weird_mode +=1
        parsed_dict["preds"].append(f"The answer is ({mode(tries)}).")
    print(f"{conunt_weird_mode=}")
    with open('/dccstor/niccoloav/mm-cot/mode.json', 'w') as f:
